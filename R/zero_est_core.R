...
#' @param value_only If \code{TRUE}, returns the minimized negative log likelihood only.
#' @details
...
#'   \item{5}{Vector Broyden-Fletcher-Goldfarb-Shanno method ver. 2}
#'   \item{6}{Simplex algorithm of Nelder and Mead ver. 2}
